        ...
        <div className="skills">
            ...
            <div className="main-techs-parent">
                <div className="main-techs">
                    ...
                    <div className="verticalLine"></div>
                    <div className="tech-details"><p>The Techs supporting above stack and i have basic knowledge in:<br /> <span className="format-skills">Kubernetes, Docker, Graphql, Cloud computing</span><br />Other techs i have  basic knowledge in <span className="format-skills">C#, Java, mySql,python</span></p></div>
                    <div className="seven tech smallscr"><p>Non tech</p></div>
                    <div className="verticalLine"></div>
                    <div className=" tech-details"><p><br /><br />The skills other than these techs are :<span className="format-skills" > Urdu content writing, SEO ,Animation video making(doodles).other than these i m </span></p></div>
                </div>
            </div>
            <div>
                <h3 >Projects</h3>
