    ...
    return (
        <div>
            ...
            <div className="Cv-grid ">
                ...
                <div className="img-cv"><a href="https://drive.google.com/file/d/1mjzsSlUAWOiemTLWOsOlgFJbxFsTNPiL/view?usp=sharing" target="_blank" className="hero-btn text-box">Read Resume</a></div>
                <div className="des"><a href="https://drive.google.com/file/d/1mjzsSlUAWOiemTLWOsOlgFJbxFsTNPiL/view?usp=sharing" target="_blank" className="hero-btn text-box">Read Resume</a></div>
                </div>
